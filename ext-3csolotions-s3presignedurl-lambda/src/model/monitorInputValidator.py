# This file will define the input validation parameters for monitor status requests.
...
class MonitorRequest(BaseModel):
    unique_id: str = Field(
        ...
        min_length=10,
        max_length=100,
        description="Unique identifier for the pipeline job (format: {uuid}_{timestamp})"
    )
